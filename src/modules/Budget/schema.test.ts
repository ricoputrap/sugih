...
describe("Budget PostgreSQL Schema Validation", () => {
  ...
  describe("Zod Schema Validation", () => {
    describe("BudgetMonthSchema", () => {
      ...
      it("should validate correct month format", () => {
        const months = ["2024-01-01", "2024-12-01", "2025-06-01", "2030-02-01"];
  ...
  describe("Nanoid Handling", () => {
    it("should handle nanoid strings in id column", () => {
      ...
      const result = BudgetIdSchema.safeParse({ id: nanoid });
      expect(result.success).toBe(true);
    });
    ...
    it("should validate nanoid format", () => {
      ...
      const validResult = BudgetIdSchema.safeParse({ id: validNanoid });
      const invalidResult = BudgetIdSchema.safeParse({ id: emptyId });
